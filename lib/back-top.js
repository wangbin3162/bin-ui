...
var _default = {
  ...
  mounted: function mounted() {
    ...
    this.domEl = this.$parent.$el.className === 'bin-scrollbar' ? this.$parent.$el.querySelector('.bin-scrollbar__wrap') : this.$parent.$el.querySelector('.scroll-box');
...
var _backTop = _interopRequireDefault(__webpack_require__(610));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _back_top_vue_vue_type_template_id_134b6eaf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(527);
