...
var _default = {
  ...
  mounted: function mounted() {
    ...
    this.domEl = this.$parent.$el.className === 'bin-scrollbar' ? this.$parent.$el.querySelector('.bin-scrollbar__wrap') : window; // 监听滚动事件

    this.throttledScrollHandler = this.$util.throttle(this.handleScroll, 300);
    (0, _dom.on)(this.domEl, 'scroll', this.throttledScrollHandler);
    (0, _dom.on)(window, 'resize', this.throttledScrollHandler);
  },
  beforeDestroy: function beforeDestroy() {
    (0, _dom.off)(this.domEl, 'scroll', this.throttledScrollHandler);
    (0, _dom.off)(window, 'resize', this.throttledScrollHandler);
  },
  methods: {
    // 滚动监听事件
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _back_top_vue_vue_type_template_id_134b6eaf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(522);
