...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_anchor_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(356);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_anchor_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_anchor_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_anchor_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_anchor_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_anchor_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
var _default = {
  ...
  methods: {
    chooseLink: function chooseLink(current) {
      this.currentLink = current;
      this.currentId = (0, _slice.default)(current).call(current, 1);
    ...
    handleScrollTo: function handleScrollTo(to) {
      var _this = this;

      var offsetTop = to - this.scrollOffset;
      this.animating = true;
      (0, _dom.scrollTop)(this.domEl, this.domEl.scrollTop, offsetTop, 1000, function () {
        _this.animating = false;
      });
    },
    handleSetInkTop: function handleSetInkTop() {
      var currentLinkElementA = document.querySelector("a[data-href=\"".concat(this.currentLink, "\"]"));
    ...
    handleScroll: function handleScroll() {
      ...
      var scrollTop = this.domEl.pageYOffset || this.domEl.scrollTop;
    ...
    updateTitleOffset: function updateTitleOffset() {
      ...
      var links = (0, _map.default)(_context = (0, _util.findComponentsDownward)(this, 'BAnchorLink')).call(_context, function (link) {
        return link.href;
      });
      var idArr = (0, _map.default)(links).call(links, function (link) {
        return link.split('#')[1];
      });
      var offsetArr = [];
      (0, _forEach.default)(idArr).call(idArr, function (id) {
        var titleEle = document.getElementById(id);

        if (titleEle) {
          offsetArr.push({
            link: "#".concat(id),
            offset: titleEle.offsetTop - _this2.scrollOffset
          });
        }
      });
  ...
  mounted: function mounted() {
    ...
    this.scroll = (0, _util.findComponentUpward)(this, 'BScrollbar');
    ...
    (0, _dom.on)(this.domEl, 'scroll', this.scrollEvent);
    (0, _dom.on)(window, 'resize', this.scrollEvent);
  ...
  beforeDestroy: function beforeDestroy() {
    (0, _dom.off)(this.domEl, 'scroll', this.scrollEvent);
    (0, _dom.off)(window, 'resize', this.scrollEvent);
  }
};
exports.default = _default;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/anchor/anchor.vue?vue&type=template&id=d5c64022&
var render = function() {
  var _vm = this
...
// CONCATENATED MODULE: ./src/components/anchor/anchor.vue?vue&type=template&id=d5c64022&
...
var _anchor = _interopRequireDefault(__webpack_require__(604));

/* istanbul ignore next */
_anchor.default.install = function (Vue) {
  Vue.component(_anchor.default.name, _anchor.default);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _anchor_vue_vue_type_template_id_d5c64022___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(524);
/* harmony import */ var _anchor_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(355);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(
  ...
  _anchor_vue_vue_type_template_id_d5c64022___WEBPACK_IMPORTED_MODULE_0__[/* render */ "a"],
  _anchor_vue_vue_type_template_id_d5c64022___WEBPACK_IMPORTED_MODULE_0__[/* staticRenderFns */ "b"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/components/anchor/anchor.vue"
