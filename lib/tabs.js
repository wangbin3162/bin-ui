  ...
  watch: {
    ...
    data: function data() {
      ...
      this.$nextTick(function () {
        _this.$refs.scrollPane.calcWidth();
      });
    }
  },
  methods: {
    ...
    toLastView: function toLastView(visitedViews, view) {
      ...
      if (lastIndex < visitedViews.length) {
        this.selectedTag = _objectSpread({}, visitedViews[lastIndex]);
      }
            ...
            [
              ...
              _vm._l(_vm.data, function(tab, index) {
                return _c(
                  ...
                  [
                    tab.icon
                      ? _c("b-icon", { attrs: { name: tab.icon, size: "16" } })
                      : _vm._e(),
                    _vm._v("\n      " + _vm._s(tab.title) + "\n      "),
                    _vm.type !== "default" && _vm.closable
                      ? _c("i", {
