...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_tabs_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(460);
...
var _scrollPane = _interopRequireDefault(__webpack_require__(748));
...
var _default = {
  ...
  props: {
    ...
    type: {
      validator: function validator(value) {
        return (0, _util.oneOf)(value, ['default', 'card', 'tag']);
      },
      default: 'default'
    },
    closable: {
  ...
  methods: {
    ...
    handleSelectTab: function handleSelectTab(tab) {
      ...
      this.selectedTag = _objectSpread({}, tab);
      this.emitInput();
      this.$nextTick(function () {
        // 计算bar位置
        _this2.calcBar();
    ...
    moveToCurrentTab: function moveToCurrentTab() {
      ...
      this.$nextTick(function () {
        ...
        try {
          for (var _iterator = (0, _getIterator2.default)(tabs), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var tab = _step.value;

            // 找到切换到的目标path和路由匹配的
            if (tab.id === _this3.value) {
              _this3.$refs.scrollPane.moveToTarget(tab);
    ...
    closeSelectedTab: function closeSelectedTab(view) {
      // 缓存tabs
      var visitedViews = (0, _util.deepCopy)(this.data);
    ...
    toLastView: function toLastView(visitedViews, view) {
      ...
      var currentIndex = (0, _findIndex.default)(visitedViews).call(visitedViews, function (t) {
      ...
      if (next < visitedViews.length) {
        this.selectedTag = _objectSpread({}, visitedViews[next]);
      } else if (next === visitedViews.length) {
        // 如果当前关闭的是最后一个tag，则判断其前一个索引是否存在，如存在则跳至前一个
        if (prev >= 0) {
          this.selectedTag = _objectSpread({}, visitedViews[prev]);
        }
      }
    ...
    calcBar: function calcBar() {
      ...
      (0, _every.default)(_context = this.data).call(_context, function (tab) {
        var tabs = _this4.$refs.tabs || [];
        var $el = (0, _find.default)(tabs).call(tabs, function (t) {
          return t.id === tab.key;
        });
  ...
  mounted: function mounted() {
    ...
    (0, _dom.on)(window, 'resize', this.calcEvent);
    this.$nextTick(function () {
      _this5.calcScrollWidth();
    });
  },
  beforeDestroy: function beforeDestroy() {
    (0, _dom.off)(window, 'resize', this.calcEvent);
  },
  components: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(462);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/tabs/tabs.vue?vue&type=template&id=6261480f&
var render = function() {
  var _vm = this
...
// CONCATENATED MODULE: ./src/components/tabs/tabs.vue?vue&type=template&id=6261480f&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/tabs/scroll-pane.vue?vue&type=template&id=112369e7&
var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.isScrollable
        ? [
            _c("span", {
              staticClass: "nav-prev iconfont icon-ios-arrow-back",
              on: { click: _vm.handlePrev }
            }),
            _vm._v(" "),
            _c("span", {
              staticClass: "nav-next iconfont icon-ios-arrow-forward",
...
// CONCATENATED MODULE: ./src/components/tabs/scroll-pane.vue?vue&type=template&id=112369e7&
/* concated harmony reexport render */__webpack_require__.d(__webpack_exports__, "a", function() { return render; });
/* concated harmony reexport staticRenderFns */__webpack_require__.d(__webpack_exports__, "b", function() { return staticRenderFns; });
...
var _tabs = _interopRequireDefault(__webpack_require__(747));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _tabs_vue_vue_type_template_id_6261480f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(557);
/* harmony import */ var _tabs_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(459);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(
  ...
  _tabs_vue_vue_type_template_id_6261480f___WEBPACK_IMPORTED_MODULE_0__[/* render */ "a"],
  _tabs_vue_vue_type_template_id_6261480f___WEBPACK_IMPORTED_MODULE_0__[/* staticRenderFns */ "b"],
  false,
  null,
  null,
  null
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scroll_pane_vue_vue_type_template_id_112369e7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(572);
/* harmony import */ var _scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(461);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(20);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(
  _scroll_pane_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _scroll_pane_vue_vue_type_template_id_112369e7___WEBPACK_IMPORTED_MODULE_0__[/* render */ "a"],
  _scroll_pane_vue_vue_type_template_id_112369e7___WEBPACK_IMPORTED_MODULE_0__[/* staticRenderFns */ "b"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/components/tabs/scroll-pane.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);
