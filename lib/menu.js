...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(416);
...
var _default2 = {
  ...
  computed: {
    classes: function classes() {
      ...
      return ["".concat(prefixCls), (0, _concat.default)(_context = "".concat(prefixCls, "-")).call(_context, theme), (0, _defineProperty2.default)({}, (0, _concat.default)(_context2 = "".concat(prefixCls, "-")).call(_context2, this.mode), this.mode)];
    },
  ...
  methods: {
    ...
    updateOpenKeys: function updateOpenKeys(name) {
      ...
      var index = (0, _indexOf.default)(names).call(names, name);

      if (this.accordion) {
        var _context3;

        (0, _forEach.default)(_context3 = (0, _util.findComponentsDownward)(this, 'BSubmenu')).call(_context3, function (item) {
          item.opened = false;
        });
      }
      ...
      if (index >= 0) {
        ...
        (0, _forEach.default)(_context4 = (0, _util.findComponentsDownward)(this, 'BSubmenu')).call(_context4, function (item) {
          if (item.name === name) {
            currentSubmenu = item;
            item.opened = false;
          }
        });
        (0, _forEach.default)(_context5 = (0, _util.findComponentsUpward)(currentSubmenu, 'BSubmenu')).call(_context5, function (item) {
          item.opened = true;
        });
        (0, _forEach.default)(_context6 = (0, _util.findComponentsDownward)(currentSubmenu, 'BSubmenu')).call(_context6, function (item) {
          item.opened = false;
        });
      } else {
        if (this.accordion) {
          ...
          (0, _forEach.default)(_context7 = (0, _util.findComponentsDownward)(this, 'BSubmenu')).call(_context7, function (item) {
            if (item.name === name) {
              _currentSubmenu = item;
              item.opened = true;
            }
          });
          (0, _forEach.default)(_context8 = (0, _util.findComponentsUpward)(_currentSubmenu, 'BSubmenu')).call(_context8, function (item) {
            item.opened = true;
          });
        } else {
          var _context9;

          (0, _forEach.default)(_context9 = (0, _util.findComponentsDownward)(this, 'BSubmenu')).call(_context9, function (item) {
            if (item.name === name) item.opened = true;
          });
        }
      }

      var openedNames = (0, _map.default)(_context10 = (0, _filter.default)(_context11 = (0, _util.findComponentsDownward)(this, 'BSubmenu')).call(_context11, function (item) {
        return item.opened;
    ...
    updateOpened: function updateOpened() {
      ...
      var items = (0, _util.findComponentsDownward)(this, 'BSubmenu'); // 判断是否展开所有submenu，如展开则全部

      if (items.length) {
        (0, _forEach.default)(items).call(items, function (item) {
          var _context12;

          item.opened = _this.expandAll ? true : (0, _indexOf.default)(_context12 = _this.openedNames).call(_context12, item.name) > -1;
        });
      } // 更新openedNames


      var openedNames = (0, _map.default)(_context13 = (0, _filter.default)(items).call(items, function (item) {
        return item.opened;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/menu/menu.vue?vue&type=template&id=203606a2&
var render = function() {
  var _vm = this
...
var _menu = _interopRequireDefault(__webpack_require__(676));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _menu_vue_vue_type_template_id_203606a2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(545);
/* harmony import */ var _menu_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(415);
