...
var _default2 = {
  ...
  methods: {
    ...
    updateOpened: function updateOpened() {
      ...
      var items = (0, _util.findComponentsDownward)(this, 'BSubmenu');

      if (items.length) {
        (0, _forEach.default)(items).call(items, function (item) {
          var _context12;

          item.opened = (0, _indexOf.default)(_context12 = _this.openedNames).call(_context12, item.name) > -1;
        });
      }
    },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _menu_vue_vue_type_template_id_203606a2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(555);
