...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(420);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_index_js_vue_loader_options_menu_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
var _link = _interopRequireDefault(__webpack_require__(681));
...
var _default = {
  name: 'BMenuItem',
  mixins: [_emitter.default, _mixin.default, _link.default],
  props: {
    name: {
      type: [String, Number],
      required: true
  ...
  methods: {
    handleClickItem: function handleClickItem(event) {
      ...
      if (newWindow || this.target === '_blank') {
        ...
        var parentMenu = (0, _util.findComponentUpward)(this, 'BMenu');

        if (parentMenu) {
          parentMenu.handleEmitSelectEvent(this.name);
        }
      } else {
        var parent = (0, _util.findComponentUpward)(this, 'BSubmenu');
  ...
  mounted: function mounted() {
    ...
    this.$on('on-update-active-name', function (name) {
      if (_this.name === name) {
        ...
        _this.dispatch('BSubmenu', 'on-update-active-name', name);
      } else {
        _this.active = false;
      }
    });
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/menu/menu-item.vue?vue&type=template&id=f61548be&
var render = function() {
  var _vm = this
...
// CONCATENATED MODULE: ./src/components/menu/menu-item.vue?vue&type=template&id=f61548be&
...
var _menuItem = _interopRequireDefault(__webpack_require__(680));

/* istanbul ignore next */
_menuItem.default.install = function (Vue) {
  Vue.component(_menuItem.default.name, _menuItem.default);
};

var _default = _menuItem.default;
exports.default = _default;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _menu_item_vue_vue_type_template_id_f61548be___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(547);
/* harmony import */ var _menu_item_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(419);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(
  ...
  _menu_item_vue_vue_type_template_id_f61548be___WEBPACK_IMPORTED_MODULE_0__[/* render */ "a"],
  _menu_item_vue_vue_type_template_id_f61548be___WEBPACK_IMPORTED_MODULE_0__[/* staticRenderFns */ "b"],
  false,
  null,
  null,
  null
...
var _default = {
  props: {
    ...
    target: {
      ...
      validator: function validator(value) {
        return (0, _util.oneOf)(value, ['_blank', '_self', '_parent', '_top']);
      },
      default: '_self'
    },
    append: {
  ...
  computed: {
    linkUrl: function linkUrl() {
      ...
      var type = (0, _typeof2.default)(this.to);

      if (type !== 'string') {
        return null;
      }

      if ((0, _includes.default)(_context = this.to).call(_context, '//')) {
  ...
  methods: {
    handleClick: function handleClick() {
      var newWindow = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var router = this.$router;
