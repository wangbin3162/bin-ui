...
var _main = _interopRequireDefault(__webpack_require__(744));
...
var _log = __webpack_require__(745);
...
var _default = {
  ...
  computed: {
    dotColor: function dotColor() {
      // 获取type的颜色
      if (this.type) {
        return (0, _log.typeColor)(this.type);
      }

      return this.color;
    },
    tagStyleBind: function tagStyleBind() {
      return this.tagStyle ? this.tagStyle : this.dot ? {
  ...
  render: function render(h) {
    ...
    $inner.push(this.$slots.default); // 有没有关闭按钮

    this.closable && $inner.push(closeEl); // tag标签

    var tagEl = h('span', {
      class: ['bin-tag', this.type ? "is-".concat(this.type) : '', this.size ? "is-".concat(this.size) : '', {
